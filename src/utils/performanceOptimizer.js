...
const { createClaudeHttpsAgent } = require('./claudeTlsAgent')
...
// ClientHello 与 Claude CLI 对齐，见 claudeTlsAgent.js。
const httpsAgentStream = createClaudeHttpsAgent({
  keepAlive: true,
...
const httpsAgentNonStream = createClaudeHttpsAgent({
  keepAlive: true,
